...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for (int v = 0; v < getNumVertices(); v++) {
			degreeSequence.add(getNeighbors(v).size() + getInNeighbors(v).size());
		}

		degreeSequence.sort(Integer::compareTo);
	...
	public static void main (String[] args) {
		GraphLoader.createIntersectionsFile("data/maps/cologne.map", "data/intersections/cologne.intersections");
