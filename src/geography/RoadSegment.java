...
public class RoadSegment {
    ...
    public RoadSegment(GeographicPoint pt1, GeographicPoint pt2, List<GeographicPoint> geometry, String roadName, String roadType, double length) {
        point1 = pt1;
        point2 = pt2;
    ...
    /**
     * Return all of the points from start to end in that order on this segment.
     *
     * @param start Start point
     * @param end End point
     */
    public List<GeographicPoint> getPoints(GeographicPoint start, GeographicPoint end) {
