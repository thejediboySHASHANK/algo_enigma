...
//           }
    ...
    private static GeographicPoint findEndOfEdge(
            HashMap<GeographicPoint, List<LinkedList<RoadLineInfo>>> pointMap,
            RoadLineInfo info,
    ...
    private static List<GeographicPoint> findIntersections(HashMap<GeographicPoint, List<LinkedList<RoadLineInfo>>> pointMap) {
...
//		GraphLoader.createIntersectionsFile("data/maps/ucsd.map", "data/intersections/ucsd.intersections");
        ...
        GraphLoader.createIntersectionsFile("data/maps/cologne.map",
                "data/intersections/cologne.intersections");
